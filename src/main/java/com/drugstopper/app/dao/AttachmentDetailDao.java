...
public class AttachmentDetailDao {
	...
	private void uploadFile(String complaintId, MultipartFile uploadedFiles) {
	...
	public List<AttachmentDetail> getAttachments(String complaintId) {
		return getSession().createQuery("From AttachmentDetail at where at.complaintReferenceId.complaintId =:complaintId").setParameter("complaintId", complaintId).list();
	}
