package com.drugstopper.app.property;

public class ConstantProperty {

	public static final String OK_STATUS  = "200";
	public static final String OTP_EXPIRED  = "301";
	public static final String UNAUTHORIZED  = "301";
	public static final String ALREADY_USER  = "101";
	public static final String USER_NOT_EXSIST  = "401";
	...
	public static final String NOT_RESISTERED_USER  = "Not Exsist User";
	...
	public static final String GMAIL_SIGN_UP  = "Gmail";
